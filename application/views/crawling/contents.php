    ...
    <body>
        <div class="header">
            <div style="float: right;">
                ...
                <?php else: ?>
                    <a style="float: right;" class="naver_login" href="/coupangProject/main/naver_logout"><img style="height: 35px;" src="http://static.nid.naver.com/oauth/small_g_in.PNG"/></a>
                <?php endif ?>
            </div>
